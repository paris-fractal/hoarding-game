...
namespace hoardinggame.Core.Tests
{
    ...
    public class JunkSystemTests
    {
        ...
        {
            var state = new GameState();
            var junk = new JunkItem("test-junk-1", "junk_can", 1.0f, 2.0f, 3.0f, 45.0f, 90.0f, 180.0f);
        ...
        {
            var state = new GameState();
            var junk1 = new JunkItem("junk-1", "junk_can", 0f, 0f, 0f, 0f, 0f, 0f);
            var junk2 = new JunkItem("junk-2", "junk_can", 1f, 1f, 1f, 0f, 0f, 0f);
        ...
        {
            var junk = new JunkItem("test-id", "junk_can", 1.5f, 2.5f, 3.5f, 10.0f, 20.0f, 30.0f);
        ...
        public void StateClonePreservesJunkItems()
        {
            ...
            var junk1 = new JunkItem("junk-1", "junk_can", 1f, 2f, 3f, 4f, 5f, 6f);
            var junk2 = new JunkItem("junk-2", "junk_can", 7f, 8f, 9f, 10f, 11f, 12f);
        ...
        {
            var originalState = new GameState();
            var junk = new JunkItem("serialized-junk", "junk_can", 10f, 20f, 30f, 45f, 90f, 135f);
        ...
        {
            var state = new GameState();
            var junk1 = new JunkItem("find-me", "junk_can", 1f, 2f, 3f, 0f, 0f, 0f);
            var junk2 = new JunkItem("not-me", "junk_can", 4f, 5f, 6f, 0f, 0f, 0f);
        ...
        public void MultipleJunkItemsCanCoexist()
        {
            ...
            {
                new JunkItem("junk-1", "junk_can",1f, 1f, 1f, 0f, 0f, 0f),
                new JunkItem("junk-2", "junk_can",2f, 2f, 2f, 10f, 20f, 30f),
                new JunkItem("junk-3", "junk_can",3f, 3f, 3f, 45f, 90f, 180f)
            };
        ...
        {
            var junk = new JunkItem("test", "junk_can", 1f, 2f, 3f, 4f, 5f, 6f);
